...
(0, node_test_1.describe)('PopularDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-popular', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-popular', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GAME_DATA_TEST_POPULAR_ENTID'];
...
//# sourceMappingURL=PopularDirect.test.js.map