...
(0, node_test_1.describe)('GetGameByIdDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-get_game_by_id', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-get_game_by_id', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["get_game_by_id01"]))
            return;
...
function liveScenariosActive() { return false && process.env.GAME_DATA_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.GameDataSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['GAME_DATA_TEST_GET_GAME_BY_ID_ENTID'];
    ...
    const client = new __1.GameDataSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetGameByIdDirect.test.js.map