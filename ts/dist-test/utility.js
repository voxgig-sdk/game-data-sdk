...
function envOverride(m) {
    if ('TRUE' === process.env.GAME_DATA_TEST_LIVE ||
        'TRUE' === process.env.GAME_DATA_TEST_OVERRIDE) {
    ...
    m.GAME_DATA_TEST_EXPLAIN = process.env.GAME_DATA_TEST_EXPLAIN || m.GAME_DATA_TEST_EXPLAIN;
    return m;
}
