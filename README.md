...
Game Data API client, generated from the OpenAPI spec.

This API serves as a robust backend for aggregating game data by merging metadata from Steam with download links from the FitGirl Repacks website.

Learn more about Game Data API at [fitgirlapi.onrender.com](https://fitgirlapi.onrender.com).

This is an unofficial SDK for the Game Data public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
This SDK exposes the API as a small set of **semantic entities** — GetGameById and Popular — that you
...
```go
client := sdk.Test()
result, err := client.GetGameById(nil).List(
    nil, nil,
)
```
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/game-data-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/game-data-sdk/tags) |
| Python | `voxgig-sdk-game-data` | publish pending — [install from git tag](https://github.com/voxgig-sdk/game-data-sdk/tags) |
| PHP | `voxgig-sdk/game-data` | publish pending — [install from git tag](https://github.com/voxgig-sdk/game-data-sdk/tags) |
| Golang | `github.com/voxgig-sdk/game-data-sdk/go` | `go get github.com/voxgig-sdk/game-data-sdk/go@latest` |
| Ruby | `voxgig-sdk-game-data` | publish pending — [install from git tag](https://github.com/voxgig-sdk/game-data-sdk/tags) |
| Lua | `voxgig-sdk-game-data` | publish pending — [install from git tag](https://github.com/voxgig-sdk/game-data-sdk/tags) |
| Go CLI | `github.com/voxgig-sdk/game-data-sdk/go-cli` | `go install github.com/voxgig-sdk/game-data-sdk/go-cli/cmd/game-data@latest` |
| Go MCP server | `github.com/voxgig-sdk/game-data-sdk/go-mcp` | `go get github.com/voxgig-sdk/game-data-sdk/go-mcp@latest` |
...
```bash
cd go-mcp && go build -o game-data-mcp .
```
...
```json
{
  "mcpServers": {
    "game-data": {
      "command": "/abs/path/to/game-data-mcp"
    }
  }
}
```
...
| --- | --- | --- |
| **GetGameById** | The GetGameById entity (list). | `/{id}` |
| **Popular** | The Popular entity (list). | `/popular` |
...
// List all getgamebyids (returns an array; throws on error)
$getgamebyids = $client->GetGameById()->list();
print_r(array_map(fn($item) => $item->data_get(), $getgamebyids));
```

### Golang

```go
import sdk "github.com/voxgig-sdk/game-data-sdk/go"

client := sdk.New()

// List all getgamebyids
getGameByIds, err := client.GetGameById(nil).List(nil, nil)
if err != nil {
    panic(err)
}
fmt.Println(getGameByIds)
```
...
# List all getgamebyids (returns an Array; raises on error)
getgamebyids = client.GetGameById.list
puts getgamebyids
```
...
Generated from the Game Data API OpenAPI spec by [@voxgig/sdkgen](https://github.com/voxgig/sdkgen).
