...
class GameDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GameDataTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = GameDataTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = GameDataTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
