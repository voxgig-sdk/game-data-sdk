...
class GameDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GameDataTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = GameDataTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = GameDataTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
