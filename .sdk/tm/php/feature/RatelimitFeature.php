...
// GameData SDK ratelimit feature
...
class GameDataRatelimitFeature extends GameDataBaseFeature
{
    ...
    private function _acquire(GameDataContext $ctx): void
    {
    ...
    private function _track(GameDataContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
