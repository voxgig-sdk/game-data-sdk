...
class GameDataRbacFeature extends GameDataBaseFeature
{
    ...
    private function _required(GameDataContext $ctx): ?string
    {
    ...
    private function _reject(GameDataContext $ctx, string $required): void
    {
    ...
    private function _track(GameDataContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
