...
class GameDataProxyFeature extends GameDataBaseFeature
{
    ...
    public function init(GameDataContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (GameDataContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
