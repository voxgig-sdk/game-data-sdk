...
// GameData SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = GameDataOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(GameDataOmni::structfix($now, Struct::undef()))
                        !== json_encode(GameDataOmni::structfix($val, Struct::undef()))) {
