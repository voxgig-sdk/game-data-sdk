...
{
    private static function utility(): GameDataUtility
    {
        return new GameDataUtility();
    }
    ...
    private static function ctx(array $over = []): GameDataContext
    {
        ...
        $ctx->op = new GameDataOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof GameDataError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new GameDataOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = GameDataMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new GameDataOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = GameDataMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new GameDataOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = GameDataMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new GameDataSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = GameDataMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new GameDataResponse([]),
            'result' => new GameDataResult([]),
        ]);
        [, $err] = GameDataMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new GameDataSpec([]),
            'response' => null,
            'result' => new GameDataResult([]),
        ]);
        [, $err] = GameDataMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new GameDataSpec(['step' => 's']),
            'response' => new GameDataResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new GameDataResult([]),
        ]);
        [, $err] = GameDataMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new GameDataSpec(['step' => 's']),
            'response' => new GameDataResponse(self::resp(200, ['v' => 1])),
            'result' => new GameDataResult([]),
        ]);
        [, $err] = GameDataMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new GameDataSpec(['step' => 's']),
            'response' => new GameDataResponse(self::resp(200, ['v' => 2])),
            'result' => new GameDataResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        GameDataMakeResponse::call($ctx);
    ...
    {
        $preset = new GameDataResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new GameDataSpec([]),
            'response' => new GameDataResponse([]),
            'result' => new GameDataResult([]),
        ...
        [$got, $err] = GameDataMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new GameDataResult([])]);
        [, $err] = GameDataMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new GameDataSpec([]), 'result' => null]);
        [, $err] = GameDataMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new GameDataSpec(['step' => 's']),
            'result' => new GameDataResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new GameDataOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = GameDataMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new GameDataSpec(['step' => 's']),
            'result' => new GameDataResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new GameDataOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = GameDataMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new GameDataResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new GameDataSpec([]),
            'result' => new GameDataResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = GameDataMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = GameDataMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new GameDataError('boom', 'boom');
        $utility->fetcher = function (GameDataContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new GameDataSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = GameDataMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (GameDataContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = GameDataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(GameDataResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (GameDataContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new GameDataSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = GameDataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new GameDataResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new GameDataSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = GameDataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = GameDataMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = GameDataMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new GameDataResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, GameDataDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new GameDataResult(['ok' => false])]);
        $this->expectException(GameDataError::class);
        GameDataDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new GameDataResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', GameDataMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        GameDataMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new GameDataBaseFeature();
        $b = new GameDataBaseFeature();
        GameDataFeatureAdd::call($ctx, $a);
        GameDataFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): GameDataBaseFeature
    {
        $f = new GameDataBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        GameDataFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): GameDataContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new GameDataSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = GameDataPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new GameDataResponse(['headers' => null]),
            'result' => new GameDataResult([]),
        ]);
        GameDataResultHeaders::call($ctx);
