...
// GameData SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class GameDataMakeRequest
{
    public static function call(GameDataContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new GameDataResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new GameDataResponse($fetched);
        } else {
