...
class GameDataGraphql
{
    ...
    // equivalent.
    public static function body(GameDataContext $ctx): mixed
    {
    ...
    public static function errors(GameDataContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
