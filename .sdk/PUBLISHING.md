...
|---|---|---|
| `ts/` | @voxgig-sdk/game-data-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/game-data-sdk \
      --repository voxgig-sdk/game-data-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/game-data-sdk` shows it, and
`npm trust revoke @voxgig-sdk/game-data-sdk --id=<id>` removes it.
