...
from gamedata_sdk.core.control import GameDataControl
...
from gamedata_sdk.core.helpers import get_ctx_prop, to_map
...
class GameDataContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, GameDataResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, GameDataResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return GameDataError(code, msg, self)
