...
from gamedata_sdk.gamedata_types import (
    GetGameById,
...
class GetGameByIdEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetGameByIdEntity(self._client, opts)
    ...
    def match_get(self) -> GetGameById:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[GetGameById]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.GetGameById().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
