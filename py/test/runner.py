...
class GameDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GameDataTestRunner.getenv("GAMEDATA_TEST_LIVE")
        override = GameDataTestRunner.getenv("GAMEDATA_TEST_OVERRIDE")
        ...
        explain = GameDataTestRunner.getenv("GAMEDATA_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["GAMEDATA_TEST_EXPLAIN"] = explain
