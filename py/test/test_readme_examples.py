# GameData SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions GameDataSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both GameDataSDK(...) and GameDataSDK.test(...) become
#      GameDataSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "gamedata_sdk"
_SDK_CLASS = "GameDataSDK"
