...
from gamedata_sdk.core.spec import GameDataSpec
from gamedata_sdk.core.result import GameDataResult
from gamedata_sdk.core.response import GameDataResponse
from gamedata_sdk.core.operation import GameDataOperation
from gamedata_sdk.core.error import GameDataError
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = GameDataSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = GameDataSDK.test(None, None)
        ...
        class TestInitFeature(GameDataBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(GameDataBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = GameDataSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = GameDataSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = GameDataSDK.test(None, setup_opts)
