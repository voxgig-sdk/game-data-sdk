...
class GameDataFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; GameDataSDK/1.0)';
    ...
    public static function call(GameDataContext $ctx, string $fullurl, array $fetchdef): array
    {
