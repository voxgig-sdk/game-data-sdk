# GameData PHP SDK Reference

Complete API reference for the GameData PHP SDK.
...
#### `GameDataSDK::test($testopts = null, $sdkopts = null)`
...
#### `GetGameById($data = null)`

Create a new `GetGameByIdEntity` instance. Pass `null` for no initial data.
