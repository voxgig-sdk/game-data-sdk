...
// GameData SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class GameDataTestFeature extends GameDataBaseFeature
{
    ...
    public function init(GameDataContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (GameDataContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (GameDataContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(GameDataContext $ctx, $op, $args): array
    {
