...
// GameData SDK clienttrack feature
...
class GameDataClienttrackFeature extends GameDataBaseFeature
{
    ...
    public function PostConstruct(GameDataContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'GameData-SDK';
