...
// GameData SDK streaming feature
...
class GameDataStreamingFeature extends GameDataBaseFeature
{
    ...
    private function _iterate(GameDataResult $result): \Generator
    {
    ...
    private function _streamable(GameDataContext $ctx): bool
    {
