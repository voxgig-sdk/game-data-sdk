...
class GameDataTimeoutFeature extends GameDataBaseFeature
{
    ...
    private function _with_timeout(GameDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(GameDataContext $_ctx, float $ms): void
    {
        $client = $this->client;
