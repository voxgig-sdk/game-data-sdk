...
class GameDataCacheFeature extends GameDataBaseFeature
{
    ...
    private function _through(GameDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
