...
class PopularEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PopularEntity($this->_client, $opts);
    }

    /**
     * @param Popular|array $args Popular data (assoc-array) to store.
     */
    ...
    /**
     * @return Popular|array The current Popular data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Popular fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Popular fields).
     */
    ...
    /**
     * List Popular items matching the given filter.
     *
     * @param PopularListMatch|array|null $reqmatch Match filter (any subset
     *   of Popular fields) as an assoc-array; PopularListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Popular[]|array A list of Popular items as assoc-arrays at
