...
// GameData SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (GameDataSDK::test)
...
{
    private const SDK_CLASS = 'GameDataSDK';
    ...
    private const SDK_BASE = 'gamedata_sdk';
