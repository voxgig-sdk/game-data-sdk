...
func registerSDKWords(r *eng.Registry, client *sdk.GameDataSDK) {
...
func runOp(client *sdk.GameDataSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
