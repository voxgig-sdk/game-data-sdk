...
describe("PopularDirect", function()
  it("should direct-list-popular", function()
    local setup = popular_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-popular", setup.live and "live" or "unit")
