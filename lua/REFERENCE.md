# GameData Lua SDK Reference

Complete API reference for the GameData Lua SDK.
...
```lua
local get_game_by_id = client:GetGameById(nil)
```
...
```lua
local results, err = client:GetGameById():list()
```
