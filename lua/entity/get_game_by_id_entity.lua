...
local GetGameByIdEntity = {}
GetGameByIdEntity.__index = GetGameByIdEntity


function GetGameByIdEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetGameByIdEntity)
  self._name = "get_game_by_id"
  self._client = client
...
function GetGameByIdEntity:get_name()
  return self._name
end


function GetGameByIdEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetGameByIdEntity.new(self._client, opts)
end
...
function GetGameByIdEntity:mark_deleted()
  self._deleted = true
end


function GetGameByIdEntity:deleted()
  return true == self._deleted
end


function GetGameByIdEntity:data_set(args)
  if args ~= nil then
...
function GetGameByIdEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetGameByIdEntity:match_set(args)
  if args ~= nil then
...
function GetGameByIdEntity:match_get()
...
function GetGameByIdEntity:stream(action, args, callopts)
...
---@param reqmatch GetGameByIdListMatch
---@param ctrl? table
---@return GetGameById[]
---@return string? err
function GetGameByIdEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function GetGameByIdEntity:_run_op(ctx, post_done)
  local utility = self._utility
