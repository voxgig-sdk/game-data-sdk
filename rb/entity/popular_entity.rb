...
class PopularEntity
  ...
  def make
    opts = @_entopts.dup
    PopularEntity.new(@_client, opts)
  end
  ...
  # @return [Popular, Hash] the current Popular data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Popular fields)
  def match_get
  ...
  #
  # @param reqmatch [PopularListMatch, Hash, nil] match filter (any subset of
  #   Popular fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Popular>, Array] the matching Popular items; raises GameDataError on failure
