...
const testSeed = `map[string]any{"entity": map[string]any{"get_game_by_id": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "popular": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
