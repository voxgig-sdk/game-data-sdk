...
func NewPopularEntity(client *core.GameDataSDK, entopts map[string]any) *PopularEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PopularEntity) GetName() string { return e.name }
...
func (e *PopularEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PopularEntity) Deleted() bool {
	return e.deleted
}


func (e *PopularEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPopularEntity(e.client, opts)
}

func (e *PopularEntity) Data(args ...any) any {
...
func (e *PopularEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Popular; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PopularEntity) DataTyped(data ...Popular) Popular {
	if len(data) > 0 {
		return typedFrom[Popular](e.Data(asMap(data[0])))
	}
	return typedFrom[Popular](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Popular (all fields
// optional at the wire level).
func (e *PopularEntity) MatchTyped(match ...Popular) Popular {
	if len(match) > 0 {
		return typedFrom[Popular](e.Match(asMap(match[0])))
	}
	return typedFrom[Popular](e.Match())
}
...
func (e *PopularEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PopularEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PopularEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PopularListMatch and returns []Popular. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PopularEntity) ListTyped(reqmatch PopularListMatch, ctrl map[string]any) ([]Popular, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Popular](res), nil
}



func (e *PopularEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PopularEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PopularEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PopularEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
