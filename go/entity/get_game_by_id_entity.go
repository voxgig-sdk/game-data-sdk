...
type GetGameByIdEntity struct {
	name    string
	client  *core.GameDataSDK
...
func NewGetGameByIdEntity(client *core.GameDataSDK, entopts map[string]any) *GetGameByIdEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetGameByIdEntity) GetName() string { return e.name }
...
func (e *GetGameByIdEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetGameByIdEntity) Deleted() bool {
	return e.deleted
}


func (e *GetGameByIdEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetGameByIdEntity(e.client, opts)
}

func (e *GetGameByIdEntity) Data(args ...any) any {
...
func (e *GetGameByIdEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetGameById; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetGameByIdEntity) DataTyped(data ...GetGameById) GetGameById {
	if len(data) > 0 {
		return typedFrom[GetGameById](e.Data(asMap(data[0])))
	}
	return typedFrom[GetGameById](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetGameById (all fields
// optional at the wire level).
func (e *GetGameByIdEntity) MatchTyped(match ...GetGameById) GetGameById {
	if len(match) > 0 {
		return typedFrom[GetGameById](e.Match(asMap(match[0])))
	}
	return typedFrom[GetGameById](e.Match())
}
...
func (e *GetGameByIdEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetGameByIdEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *GetGameByIdEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetGameByIdListMatch and returns []GetGameById. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GetGameByIdEntity) ListTyped(reqmatch GetGameByIdListMatch, ctrl map[string]any) ([]GetGameById, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[GetGameById](res), nil
}



func (e *GetGameByIdEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetGameByIdEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetGameByIdEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetGameByIdEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
