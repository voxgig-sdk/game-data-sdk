...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get_game_by_id | popular"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.GameDataSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "game-data_list",
		Description: "List records from GameData. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "game-data_load",
		Description: "Load a single record from GameData. " +
...
func runOp(client *sdk.GameDataSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.GameDataSDK, name string) (sdk.GameDataEntity, error) {
	switch strings.ToLower(name) {
	case "get_game_by_id":
		return client.GetGameById(nil), nil
	case "popular":
		return client.Popular(nil), nil
